...
use wasm_bindgen::{
    closure::WasmClosure, prelude::Closure, closure::WasmClosureFnOnce,
    JsCast,
    //JsValue,
};
...
use web_sys::{
    CanvasRenderingContext2d, Document, HtmlCanvasElement, Window, HtmlImageElement,
    //CanvasRenderingContext2d, Document, HtmlCanvasElement, Response, Window, HtmlImageElement,HtmlElement,
};
